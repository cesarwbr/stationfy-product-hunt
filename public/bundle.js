...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productList = __webpack_require__(168);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _productCard = __webpack_require__(216);
	...
	var ProductList = function (_React$Component) {
	  ...
	  function ProductList(props) {
	    ...
	    _this.handleProductClick = _this.handleProductClick.bind(_this);
	  ...
	  _createClass(ProductList, [{
	    ...
	    value: function handleProductClick(id) {
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_loading2.default, { loading: this.props.productsLoading }),
	        _react2.default.createElement(
	          'ul',
	          { className: 'products' },
	          this.props.products.map(function (product) {
	            return _react2.default.createElement(_productCard2.default, _extends({}, product, {
	              key: product.id,
	              handleProductClick: _this2.handleProductClick
	            }));
	          })
	        ),
	...
	exports.default = (0, _store.connector)(ProductList);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Header = exports.Header = function (_React$Component) {
	  ...
	  _createClass(Header, [{
	    ...
	    key: 'render',
	    value: function render() {
	      var popularClass = 'menu--item ';
	      var recentClass = 'menu--item ';
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: '#', 'data-type': 'popular', onClick: this.handleMenuClick },
	              'Popular'
	            )
	          ),
	          _react2.default.createElement(
	            ...
	            _react2.default.createElement(
	              'a',
	              { href: '#', 'data-type': 'recent', onClick: this.handleMenuClick },
	              'Recent'
	            )
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'profile' },
	          _react2.default.createElement('img', { className: 'photo', src: 'https://ph-avatars.imgix.net/121699/original?auto=format&fit=crop&crop=faces&w=32&h=32' }),
	          _react2.default.createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _appAction = __webpack_require__(215);
	
	var _productsAction = __webpack_require__(214);
	
	var _commentsAction = __webpack_require__(195);
	...
	store.dispatch((0, _productsAction.fetchProducts)('popular'));
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    setProductListType: function setProductListType(type) {
	      dispatch((0, _appAction.setProductListType)(type));
	      dispatch((0, _productsAction.cleanProducts)());
	      dispatch((0, _productsAction.fetchProducts)(type));
	    },
	    setProduct: function setProduct(product) {
	      dispatch((0, _appAction.setProduct)(product));
	      dispatch((0, _commentsAction.cleanComments)());
	      dispatch((0, _commentsAction.fetchComments)(product.id));
	    },
	    setModal: function setModal(modal) {
	      dispatch((0, _appAction.setModal)(modal));
	    },
	    setProducts: function setProducts(products) {
	      dispatch((0, _appAction.setProducts)(products));
	    }
	  };
	};
	
	var connector = exports.connector = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(178)(global || window || undefined);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var appReducer = function appReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? appInitialState : arguments[0];
	  var action = arguments[1];
	
	  var newState = {};
	
	  switch (action.type) {
	    case _appAction.SET_PRODUCT_LIST_TYPE:
	      Object.assign(newState, state, {
	        productListType: action.value,
	        products: []
	      });
	      return newState;
	    case _appAction.SET_PRODUCT:
	      Object.assign(newState, state, {
	        product: action.value,
	        comments: []
	      });
	      return newState;
	    case _appAction.SET_MODAL:
	      Object.assign(newState, state, { modal: action.value });
	      return newState;
	    case _appAction.SET_PRODUCTS:
	...
	var commentsInitialState = {
	  comments: [],
	  commentsLoading: false
	};
	
	var commentsReducer = function commentsReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? commentsInitialState : arguments[0];
	  var action = arguments[1];
	
	  var newState = {};
	
	  switch (action.type) {
	    case _commentsAction.CLEAN_COMMENTS:
	      Object.assign(newState, state, { comments: [] });
	      return newState;
	    case _commentsAction.REQUEST_COMMENTS:
	      Object.assign(newState, state, { commentsLoading: true });
	      return newState;
	    case _commentsAction.RECEIVE_COMMENTS:
	...
	var productsReducer = function productsReducer() {
	  var state = arguments.length <= 0 || arguments[0] === undefined ? productsInitialState : arguments[0];
	  var action = arguments[1];
	
	  var newState = {};
	
	  switch (action.type) {
	    case _productsAction.CLEAN_PRODUCTS:
	      Object.assign(newState, state, { products: [] });
	      return newState;
	    case _productsAction.REQUEST_PRODUCTS:
	      Object.assign(newState, state, { productsLoading: true });
	      return newState;
	    case _productsAction.RECEIVE_PRODUCTS:
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CLEAN_COMMENTS = exports.RECEIVE_COMMENTS = exports.REQUEST_COMMENTS = undefined;
	...
	var fetch = _axios2.default.create();
	...
	var CLEAN_COMMENTS = exports.CLEAN_COMMENTS = 'CLEAN_COMMENTS';
	...
	function fetchComments(id) {
	  var apiURL = 'http://localhost:8080/api/comments/' + id;
	
	  return function (dispatch) {
	    dispatch(requestComments());
	    return fetch.get(apiURL).then(function (json) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.CLEAN_PRODUCTS = exports.RECEIVE_PRODUCTS = exports.REQUEST_PRODUCTS = undefined;
	...
	var CLEAN_PRODUCTS = exports.CLEAN_PRODUCTS = 'CLEAN_PRODUCTS';
	...
	function fetchProducts(type) {
	  var apiURL = 'http://localhost:8080/api/products/popular';
	  ...
	  return function (dispatch) {
	    ...
	    return fetch.get(apiURL).then(function (json) {
	      return dispatch(receiveProdcuts(json));
	    }).catch(function (err) {
	      console.log(err);
	    });
	  };
...
/***/ function(module, exports) {
	...
	exports.setProductListType = setProductListType;
	...
	// Actions
	var SET_PRODUCT_LIST_TYPE = exports.SET_PRODUCT_LIST_TYPE = 'SET_PRODUCT_LIST_TYPE';
	 ...
	 */
	function setProductListType(value) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductCard = function (_React$Component) {
	  ...
	  function ProductCard(props) {
	    ...
	    _this.handleProductClickEvent = _this.handleProductClickEvent.bind(_this);
	    return _this;
	  }
	
	  _createClass(ProductCard, [{
	    key: 'handleProductClickEvent',
	    value: function handleProductClickEvent() {
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        'li',
	        { className: 'product-card', onClick: this.handleProductClickEvent },
	        _react2.default.createElement(
	          'div',
	          { className: 'product-card--content' },
	          _react2.default.createElement('img', { src: this.props.thumbnail.image_url, className: 'product-card-img' }),
	          _react2.default.createElement(
	            'div',
	  ...
	  _createClass(Loading, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { src: 'img/jar-loading.gif' })
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _discussion = __webpack_require__(219);
	...
	var Modal = function (_React$Component) {
	  ...
	  function Modal(props) {
	    ...
	    _this.handleCloseModalEvent = _this.handleCloseModalEvent.bind(_this);
	    _this.blockClicks = _this.blockClicks.bind(_this);
	    return _this;
	  }
	
	  _createClass(Modal, [{
	    key: 'handleCloseModalEvent',
	    value: function handleCloseModalEvent() {
	      this.props.handleCloseModal();
	    }
	  }, {
	    key: 'blockClicks',
	    value: function blockClicks(event) {
	      event.stopPropagation();
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      var modalClass = 'modal modal-overlay';
	      ...
	      return _react2.default.createElement(
	        'div',
	        { className: modalClass, onClick: this.handleCloseModalEvent },
	        _react2.default.createElement('a', { href: '#', onClick: this.handleCloseModalEvent, className: 'modal-overlay__close' }),
	        _react2.default.createElement(
	          'div',
	          { className: 'modal-overlay--content', onClick: this.blockClicks },
	          _react2.default.createElement(
	            'div',
	            { className: 'modal-overlay--content--header' },
	            _react2.default.createElement(
	              'h1',
	              null,
	              this.props.name
	            ...
	            _react2.default.createElement('img', { className: 'photo', src: this.props.user.image_url['48px'] })
	          ),
	          _react2.default.createElement(
	            'div',
	            { className: 'modal-overlay--content--body' },
	            _react2.default.createElement(
	              'div',
	              { className: 'modal-overlay--meta' },
	              _react2.default.createElement(
	                'ul',
	                null,
	                _react2.default.createElement(
	                  'li',
	                  { className: 'modal-overlay--meta--item' },
	                  _react2.default.createElement(
	                    'span',
	                    null,
	                    _react2.default.createElement('img', { src: 'https://d13yacurqjgara.cloudfront.net/assets/icon-shotstat-like-6a1e9e9db48b9b788639f05a658379b7bb027a75d256127f812bf9392664396f.png' }),
	                    _react2.default.createElement(
	                      'span',
	                      { className: 'modal-overlay--meta--likes' },
	                ...
	                _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'ol',
	                      { className: 'modal-overlay--meta--topics' },
	                      this.props.topics.map(function (topic) {
	                        return _react2.default.createElement(
	                          'li',
	                          { key: topic.id, className: 'modal-overlay--meta--topic' },
	                          _react2.default.createElement(
	                            'span',
	                            null,
	                            topic.name
	            ...
	            _react2.default.createElement(
	              'div',
	              { className: 'modal-overlay--content--body--image' },
	              _react2.default.createElement('img', { src: this.props.thumbnail.image_url })
	            ),
	            _react2.default.createElement(
	              'div',
	              { className: 'modal-overlay--content--body--description' },
	              this.props.tagline
	            )
	          ),
	          _react2.default.createElement(_discussion2.default, { loading: this.props.loading, comments: this.props.comments })
	        )
	      );
	    }
	  }]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Discussion = function (_React$Component) {
	  _inherits(Discussion, _React$Component);
	
	  function Discussion() {
	    _classCallCheck(this, Discussion);
	
	    return _possibleConstructorReturn(this, Object.getPrototypeOf(Discussion).apply(this, arguments));
	  }
	  ...
	  _createClass(Discussion, [{
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(_loading2.default, { loading: this.props.loading }),
	        _react2.default.createElement(
	          'ol',
	          ...
	          this.props.comments.map(function (comment) {
	            return _react2.default.createElement(
	              'li',
	              { key: comment.id, className: 'discussion--item' },
	              _react2.default.createElement(
	                'h2',
	                null,
	                comment.user.name
	              ),
	              _react2.default.createElement('img', { className: 'discussion--item--photo', src: comment.user.image_url['32px'] }),
	              _react2.default.createElement(
	                'div',
